...
public class Patient {
    ...
    public Patient(double age,VitalSigns2 vitalsigns,String name) {
        this.age=age;
    ...
    public void  isThisVitalSignNormal(double age,VitalSigns2 vitalsigns){
    ...
    public void isPatientNormal(double age,VitalSigns2 vitalsigns){
        findAge(age);
    ...
    public void testRespiratoryRate(double age,VitalSigns2 vitalsigns) {
        if(age<0){
            System.out.println("False");
        }
        else if (age<0.0834) {
    ...
    private void testWeightInKilos(double age,VitalSigns2 vitalsigns) {
        if(age<0){
            System.out.println("False");
        }
        else if (age<0.0834) {
    ...
    private void testSystolicBloodPressure(double age,VitalSigns2 vitalsigns) {
        if(age<0){
            System.out.println("False");
        }
        else if (age<0.0834) {
    ...
    private void testHeartRate(double age,VitalSigns2 vitalsigns) {
        if(age<0){
            System.out.println("False");
        }
        else if (age<0.0834) {
    ...
    private void testWeightInPounds(double age,VitalSigns2 vitalsigns) {
        if(age<0){
            System.out.println("False");
        }
        else if (age<0.0834) {
